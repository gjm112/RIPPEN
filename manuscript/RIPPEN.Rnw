...
\section{Methods}
The idea of this method is to model the distribution of play outcomes from a certain quarterback.  Once we have a model for the ditribution of play outcomes, drives can be simulated based on this distribution.  One could then look at drive outcomes and rate quarterbacks based on the value of these simulated outcomes.  

\begin{itemize}
\item Model the distribution of play outcomes from a quarterback and then simulate drives using that distribution.  
\item Drive starts on 20 yard line at 1st and 10.  
\item Simulate if the pass was an interception. 
\begin{itemize}
...
>>>>>>> ff2523cd6ca412517e2be8ec5608d09b303e01e3
