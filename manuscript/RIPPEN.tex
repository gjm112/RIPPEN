...
%Censoring in rjags
\section{Introduction to Current Passer Rating Systems}
Quantifying the performance of a quarterback is one of the most persistent challenges in sports analytics. While numerous metrics exist, most rely on arbitrary weighting systems or proprietary formulas that lack transparency. In this section, we review the three most prominent passer rating systems—NFL Passer Rating, NCAA Passing Efficiency, and Total QBR—and discuss their limitations.
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in file(file, "{}rt"{}): cannot open file '/Users/gregorymatthews/Dropbox/RIPPENgit/data/total09-18\_pbp\_data.csv': No such file or directory}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in file(file, "{}rt"{}): cannot open the connection}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: object 'nfl' not found}}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in readChar(con, 5L, useBytes = TRUE): cannot open compressed file '/home/don/Dropbox/RIPPENgit/RIPPEN\_2018\_season\_df.RData', probable reason 'No such file or directory'}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in readChar(con, 5L, useBytes = TRUE): cannot open the connection}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: object 'rippen2018\_season' not found}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: object 'tab' not found}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: object 'rippen2018\_season' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: object 'results' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in dist\$X7: object of type 'closure' is not subsettable}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in dist\$X0: object of type 'closure' is not subsettable}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in dist\$X3: object of type 'closure' is not subsettable}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in dist\$X7: object of type 'closure' is not subsettable}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in dist\$name <- row.names(dist): object of type 'closure' is not subsettable}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in `ggplot()`:\\\#\# ! `data` cannot be a function.\\\#\# i Have you misspelled the `data` argument in `ggplot()`?}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: object 'gg' not found}}\end{kframe}
\end{knitrout}
